...
> **Project Card** — for citation, reference, and quick understanding.

| Field | Value |
|-------|-------|
| **Title** | Academic Workflow: A Reproducible AI-Augmented Research Pipeline for Geography |
| **Type** | Research infrastructure / Methodology framework |
| **Domain** | Geography, GIS, Remote Sensing, Environmental Science, Spatial Analysis |
| **Core Innovation** | Full-stack integration of AI agents (Claude/Codex) with reproducible GIS workflows — paper reading → figure production → manuscript writing → group presentation, all governed by quality gates and evidence tracking |
| **Key Components** | (1) 7-engine PDF extraction cascade, (2) 7-dimension 100-point paper scoring rubric with 22-field knowledge cards, (3) ScholarFlow 8-node literature review pipeline, (4) QGIS automation module with figure release gate, (5) AI-augmented academic writing system with anti-fraud verification, (6) Semantic knowledge graph with CLI query, (7) Reproducible project template with built-in quality gate, (8) Claude-Codex agent handoff protocol for code execution and figure production |
| **Data Scope** | No bundled research data — ships with synthetic test fixtures only. Real data stays with each research project |
| **Tech Stack** | Python 3.10+, PDF processing (PyMuPDF/pdfplumber/EasyOCR/Tesseract), QGIS/PyQGIS, Google Earth Engine, OriginLab, Jupyter, Git |
| **Target Users** | Graduate students and researchers in geography, GIS, remote sensing, soil erosion, hydrology, and related fields |
| **License** | MIT |
| **Status** | Active development (2026-07) — Core pipeline stable, expanding figure and writing subsystems |
